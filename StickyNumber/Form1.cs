// Made By aFard , github : github.com/afard
...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        public void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Select a range , than find the random number!");
        ...
        public void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (num == randnum)
            {
                ...
                command.CommandText = @$"INSERT INTO rec(records) VALUES({A})";
    ...
    public void button4_Click(object sender, EventArgs e)
        ...
        {
            MessageBox.Show("A game by aFard , Get latest version and help at : github.com/afard88 , StickyNumber");
        }
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            connection.Open();
            using var command = new SQLiteCommand(connection);
            command.CommandText = @"SELECT records FROM rec";
            command.ExecuteNonQuery();
            SQLiteDataReader reader = command.ExecuteReader();
            readout = "Your Records Are : ";
            while (reader.Read())
            {

                int readint = reader.GetInt32(0);
                readout = readout + readint + ", " ;

            }
            MessageBox.Show(readout.ToString() , "Records");
